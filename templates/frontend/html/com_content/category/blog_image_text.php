...
<h2><?php echo $this->item->jcfields[21]->rawvalue; ?></h2>
...
<article class="image_text">
    ...
    <div class="spieletypbutton__containertext" >
        <h2 id="spieletyp"> Dein Spieltyp </h2>
        <div id="Spieltyptext">
        nvidunt ut labore et dolore magna aliquyam erat, sed <br>
        diam voluptua. At vero eos et accusam
        </div>
        <div class="spieletypbutton__menu-item" type="button" >
        <div class="spieletypbutton__menu-text" align="center"> Spieltyp herausfinden
        </div>
        </div>
    </div>
        <div class="spieletypbutton__containerbild" >
            <div class="spieltypbild">
                <img class="spieleuebersichtbild" src="images/Startseite/spieleuebersicht_spieltyp.png" width="300" height="150" alt="Ein Alternativtext">
            </div>
        </div>
</article>
-->
